               ...
               <div class="checkout-form" <?php echo $display?>>
                  <form method="POST" enctype="multipart/form-data">
                     <div class="row">
                        ...
                        <div class="row">
                           <div class="col-lg-6 error" id="result">
                              <p style="margin-left:20%;">Image Preview</p>
                              <img class="image-preview" src="https://dummyimage.com/300x300/fff&text=300x300" alt="" srcset="">
                           </div>
                           <div class="col-lg-6">
                              <div class="form-group">
                                 <label class="form-control-label">Photo</label>
                                 <input style="margin-top:20%" type="file" id="image" onchange="validateImage(event)">   
                              </div>
                           </div>
                        </div>
