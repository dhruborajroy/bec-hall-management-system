                ...
                <div class="card">
                    <div class="card-body">
                        <div class="heading-layout1">
                            ...
                            <div class="dropdown">
                                <a  href="../webadmin/pdfreports/meal_status.php?month=<?php if($month!=""){echo $month;}else{echo date('m');}?>&year=<?php if($year!=""){echo $year;}else{echo date('Y');}?>" role="button">Go to print page</a>
                            </div>
                        </div>
