...
define("APP_KEY","nAjRxg1lc6eEMdmwkTHyJxyztc");
define("APP_SECRET","AabfRBCBxUxYKGNVpenNEBcfptxjVfPIDGGxlHyXbNPLliopt9oK");
define("USERNAME","01753335815");
define("PASSWORD","{3KOw3H@wtK");
define("BASE_URL",'https://tokenized.pay.bka.sh/v1.2.0-beta');
define("FORM_AMOUNT",1);
